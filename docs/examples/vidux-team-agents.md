...
Use the audit output as the handoff preflight. It tells the next agent whether the manifest is valid, internal links pass, a checkpoint exists, and documentation/config files are already dirty before the agent regenerates anything.
