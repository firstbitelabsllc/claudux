...
<template>
  <main class="claudux-home">
    ...
    <figure>
      <video controls preload="metadata" :poster="withBase('/claudux-demo.png')" aria-label="Claudux protected-section demo">
