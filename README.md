...
Hand-written architecture docs rot the week after you ship. Claudux is the middle path: your repo still owns structure and protected sections; an authenticated Claude or Codex CLI only proposes wording for the pages you already decided matter. Use it when you want guides and command references that can be re-run, not a one-shot dump into a markdown folder.
