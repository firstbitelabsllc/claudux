...
show_help() {
    ...
    echo "    section-bounded and hash-guarded (pinned + skip-marker blocks)"
    echo "  • Without it: prompts steer the model away from notes/, private/,"
    echo "    and secrets — guidance, not an enforced barrier"
    echo ""
}
