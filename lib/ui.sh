...
show_help() {
    ...
    echo "  claudux update --check  - CI drift gate: exit 2 if docs would change, writing nothing"
    ...
    echo "  --check                  - Drift gate for CI (update command): 0=clean, 2=drift, 1=error"
    echo ""
    echo "Environment:"
